# বেস টেমপ্লেট KMP অ্যাপ

আপনার **Kotlin Multiplatform (KMP)** উন্নয়ন এই GitHub টেমপ্লেট রিপোজিটরি দিয়ে শুরু করুন। [হৃদয় চন্দ্র দাস](https://github.com/ihridoydas) এর ডিজাইন করা এই প্রজেক্টটি Android, iOS, Desktop, এবং Web (Wasm) অ্যাপ্লিকেশনের জন্য একটি শক্তিশালী ভিত্তি প্রদান করে।
